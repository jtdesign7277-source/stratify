...
export default function SportsBankroll() {
  ...
  return (
    <motion.div
      ...
      className="w-full rounded-2xl border border-white/[0.06] bg-gradient-to-br from-white/[0.04] to-white/[0.01] p-5 shadow-[0_8px_32px_rgba(0,0,0,0.4)] backdrop-blur-xl"
    >
