            ...
            <div className="mt-20 mb-16 flex flex-col items-center gap-10">
              ...
              <div className="flex items-center justify-center gap-12 flex-wrap">
                ...
                <a href="https://stripe.com" target="_blank" rel="noopener noreferrer" className="opacity-50 hover:opacity-90 transition-opacity duration-300">
                  <svg viewBox="0 0 60 25" fill="white" height="32" xmlns="http://www.w3.org/2000/svg"><path d="M5 10.2c0-.7.6-1 1.5-1 1.4 0 3.1.4 4.5 1.2V6.3C9.5 5.7 8 5.3 6.5 5.3 2.6 5.3 0 7.3 0 10.5c0 5 6.8 4.2 6.8 6.3 0 .8-.7 1.1-1.7 1.1-1.5 0-3.4-.6-4.9-1.5v4.2c1.7.7 3.3 1 4.9 1 4 0 6.7-2 6.7-5.2C11.8 11 5 11.9 5 10.2zm13.5-2.3l-.2-2.5h-4v15h4.5v-10c1.1-1.4 2.9-1.1 3.5-.9V5.4c-.6-.2-2.8-.6-3.8 2.5zm9.5 7.1c0-2 1.2-3 2.5-3s2.5 1 2.5 3-1.2 3-2.5 3-2.5-1-2.5-3zm-4.5 0c0 4.5 3.2 8.1 6.8 8.1 1.5 0 2.8-.5 3.8-1.3v1h4.5V5.4h-4.5V6c-1-.8-2.3-1.4-3.8-1.4-3.6 0-6.8 3.7-6.8 8.1v.3zm22.3-9.7c-1.6 0-2.6.7-3.2 1.3l-.2-1H38v20.5h4.5v-5c.6.4 1.5.7 2.5.7 3.5 0 6.8-3.6 6.8-8.1 0-4.3-3.1-8.4-6.8-8.4zm-1.2 12.7c-1.3 0-2-.5-2.5-1.1V9.1c.5-.7 1.3-1.2 2.5-1.2 1.9 0 3.2 2.2 3.2 4.5s-1.3 4.6-3.2 4.6zM58 12.3c0-4.5-2.2-8-6.3-8-4.2 0-6.7 3.5-6.7 8 0 5.3 3 8 7.2 8 2.1 0 3.6-.5 4.8-1.1v-3.5c-1.2.6-2.5 1-4.2 1-1.7 0-3.1-.6-3.3-2.6h8.3c0-.2.2-1.2.2-1.8zm-8.4-1.7c0-1.9 1.2-2.7 2.2-2.7s2.1.8 2.1 2.7h-4.3z" fillRule="evenodd"/></svg>
                </a>
        ...
        <footer className="border-t border-gray-800 px-6 py-8">
          <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-gray-500">
            ...
            <div className="flex items-center gap-4">
              ...
              <a href="https://discord.gg/6RPsREggYV" target="_blank" rel="noopener noreferrer" className="hover:text-[#5865F2] transition-colors" title="Join Discord">
                <svg width="16" height="12" viewBox="0 0 71 55" fill="currentColor"><path d="M60.1 4.9C55.6 2.8 50.7 1.3 45.7.4c-.1 0-.2 0-.2.1-.6 1.1-1.3 2.6-1.8 3.7-5.5-.8-10.9-.8-16.3 0-.5-1.2-1.2-2.6-1.8-3.7 0-.1-.1-.1-.2-.1C20.3 1.3 15.4 2.8 10.9 4.9c0 0-.1 0-.1.1C1.6 18.7-.9 32.1.3 45.4v.2c6.1 4.5 12 7.2 17.7 9 .1 0 .2 0 .2-.1 1.4-1.9 2.6-3.8 3.6-5.9.1-.1 0-.3-.1-.3-2-.7-3.8-1.6-5.6-2.7-.1-.1-.1-.3 0-.4.4-.3.7-.6 1.1-.9.1-.1.1-.1.2-.1 11.6 5.3 24.2 5.3 35.7 0h.2c.4.3.7.6 1.1.9.1.1.1.3 0 .4-1.8 1-3.6 2-5.6 2.7-.1.1-.2.2-.1.3 1.1 2.1 2.3 4.1 3.6 5.9.1.1.2.1.2.1 5.8-1.8 11.6-4.5 17.7-9 0 0 .1-.1.1-.2 1.5-15.6-2.5-29.1-10.7-41.1 0 0 0 0-.1-.1z"/></svg>
              </a>
            </div>
          </div>
        </footer>
