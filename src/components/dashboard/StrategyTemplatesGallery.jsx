...
const StrategyTemplatesGallery = ({ onSelectTemplate = () => {} }) => {
  ...
  return (
    <div className="h-full overflow-y-auto bg-[#0a0a0f] p-6 text-white">
      ...
      <div className="mt-6 grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
        {featuredTemplate && (
          <div className="md:col-span-2 lg:col-span-3">
            <div className="relative h-full rounded-2xl border border-emerald-500/60 bg-gradient-to-br from-[#0a0a0f] via-[#0d0d12] to-[#0f0f14] p-6">
              ...
              <div className="mt-4 flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <button
                    ...
                    className="mt-2 inline-flex items-center justify-center rounded-lg bg-emerald-500 px-4 py-2 text-sm font-semibold text-white transition hover:bg-emerald-400"
                  >
                    Use Template
                  </button>
                </div>
        ...
        {standardTemplates.map((template) => (
          <div
            key={template.id}
            className="flex h-full flex-col rounded-2xl border border-[#1e1e2d] bg-[#0d0d12] p-5"
          >
            ...
            <button
              ...
              className="mt-5 inline-flex items-center justify-center rounded-lg border border-[#2a2a3a] bg-[#0f0f14] px-4 py-2 text-sm font-medium text-white transition hover:border-emerald-500/60 hover:bg-emerald-500/10"
            >
              Use Template
            </button>
          </div>
