...
const TIMEFRAME_MAP = {
  ...
  '1H': '1h', '2H': '2h', '4H': '4h', '1D': '1day', '1Mo': '1month',
};
...
function StrategyRadarContent() {
  ...
  useEffect(() => {
    const t = setTimeout(() => {
      if (priceAlertsRef.current) setHasAlerts(priceAlertsRef.current.getAlertCount() > 0);
    }, 150);
    return () => clearTimeout(t);
  }, [selectedTicker]);
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className="flex-1 flex flex-col border-r border-white/6 min-w-0">
          ...
          <div className="flex-1 min-h-0 relative flex flex-col">
            {alertPopup && (
              <div className="fixed left-1/2 top-[120px] z-[10000] -translate-x-1/2 pointer-events-none" role="alert">
                <div
