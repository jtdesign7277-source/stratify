          ...
          {stocks.map((stock) => {
            ...
            return (
              <div 
                ...
                className={`flex items-center justify-between px-4 py-3 cursor-pointer transition-colors border-b border-gray-800/50 group ${
              ...
              >
                ...
                <div className="flex-1 min-w-0 pr-4">
                  <div className="flex items-center gap-2">
                    <span className="text-white font-semibold text-base">{stock.symbol}</span>
                    <button 
                      onClick={(e) => handleRemoveStock(stock.symbol, e)}
                      className="opacity-0 group-hover:opacity-100 p-1 hover:bg-red-500/20 rounded transition-all text-gray-500 hover:text-red-400"
                    >
