...
export default function StratifyApp() {
  ...
  return <KrakenDashboard setCurrentPage={setCurrentPage} alpacaData={{ positions: positions.length > 0 ? positions : stocks, account: account || { equity: 0, cash: 0, buying_power: 0 } }} />;
}
