-- ============================================================
-- STRATIFY X-RAY FUNDAMENTALS SCHEMA
-- ============================================================
...
-- Company Statistics & Profile (key metrics)
...
-- Real-time quote cache (updates frequently)
...
-- Revenue segment breakdown (custom parsed from income statement)
...
-- ALTER TABLE xray_income_statement ENABLE ROW LEVEL SECURITY;
-- ALTER TABLE xray_balance_sheet ENABLE ROW LEVEL SECURITY;
-- ALTER TABLE xray_cash_flow ENABLE ROW LEVEL SECURITY;
-- ALTER TABLE xray_statistics ENABLE ROW LEVEL SECURITY;
-- ALTER TABLE xray_quotes ENABLE ROW LEVEL SECURITY;
