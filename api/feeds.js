...
// Keep search terms short (1-3 words) for best Marketaux results
const FEED_PARAMS = {
  // Market Pulse
  Earnings:     { search: 'earnings' },
  Momentum:     { search: 'stock rally surge' },
  ...
  Commodities:  { search: 'gold oil commodities' },
  Forex:        { search: 'forex dollar' },
  Housing:      { search: 'housing mortgage' },
  Jobs:         { search: 'jobs employment' },
  // Crypto
  Bitcoin:      { search: 'bitcoin' },
  Ethereum:     { search: 'ethereum' },
  Altcoins:     { search: 'altcoin crypto' },
  DeFi:         { search: 'DeFi crypto' },
  CryptoNews:   { search: 'cryptocurrency' },
  // Strategy & Education
  TechnicalAnalysis: { search: 'technical analysis' },
  Fundamentals:      { search: 'valuation analysis' },
  DayTrading:        { search: 'day trading' },
  ...
  TradingMemes: { search: 'Wall Street market' },
  HotTakes:     { search: 'market forecast prediction' },
}
